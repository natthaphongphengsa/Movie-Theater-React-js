    ...
    return (
        <div className='w-full h-[750px] text-white'>
            <div className='w-full h-full'>
                <div className='absolute w-full h-[750px] bg-gradient-to-r from-black'>
                    <div className='absolute top-[30%] w-full md:w-[50%] p-10'>
                ...
                <img className='w-full h-full object-cover bg-center' src={`https://image.tmdb.org/t/p/original/${randomMovie?.backdrop_path}`} alt={randomMovie?.title}/>
            </div>
        </div>
    )
}