                ...
                <div className='pt-32 container mx-auto mb-12'>
                    <div className='flex lg:flex-row flex-col' data-aos="fade" data-aos-duration="1000">
                        ...
                        <div className='px-4 lg:w-3/5'>
                            <h1 className='lg:text-5xl text-3xl'>{movie?.original_title}</h1>
                    ...
                    <br></br>
                    <div className={`${castAvailable ? "visible": "hidden"} max-w-full mt-8 px-4`} data-aos="fade" data-aos-duration="1500">
                    ...
                    <div className='grid md:grid-cols-1 lg:grid-cols-1 gap-4 mt-14 px-4' id="goToVideo">
                    ...
                    <div className={`${similarAvailable ? "visible": "hidden"} max-w-full mt-8 px-4`} data-aos="fade" data-aos-duration="1500">
